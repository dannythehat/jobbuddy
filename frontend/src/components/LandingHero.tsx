...
const LandingHero: React.FC = () => (
  <Box sx={{
    textAlign: 'center', py: 8, mb: 8, color: 'white', borderRadius: 4,
    ...
    <Container maxWidth="md">
      ...
      <Button component={RouterLink} to="/register" variant="contained" size="large" sx={{
        ...
        px: 4, py: 1.5, fontWeight: 'bold', mr: 2,
      }}>
        Start Free Trial 🚀
      </Button>
      <Button component={RouterLink} to="/login" variant="outlined" size="large" sx={{
